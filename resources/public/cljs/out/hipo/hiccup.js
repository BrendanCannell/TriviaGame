...
var or__3949__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469).cljs$core$IFn$_invoke$arity$1(m),s);
...
if((i__$1 > (0))){
var G__21779 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__21779;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__3938__auto__ = id;
...
if(cljs.core.truth_((function (){var or__3949__auto__ = id;
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
return cs;
...
return cljs.core.merge.call(null,m_QMARK_,(cljs.core.truth_(id)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),id], null):null),(cljs.core.truth_(cs)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var temp__5455__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(m_QMARK_);
...
hipo.hiccup.Sentinel.cljs$lang$ctorPrWriter = (function (this__4192__auto__,writer__4193__auto__,opt__4194__auto__){
return cljs.core._write.call(null,writer__4193__auto__,"hipo.hiccup/Sentinel");
});
...
var G__21781 = (function (){var f = cljs.core.first.call(null,s);
if(cljs.core.truth_((function (){var or__3949__auto__ = hipo.hiccup.literal_QMARK_.call(null,f);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
var G__21782 = cljs.core.rest.call(null,s);
v = G__21781;
s = G__21782;
continue;
} else {
...
var G__21783 = ((cljs.core.seq_QMARK_.call(null,f))?hipo.hiccup.conjs_BANG_.call(null,acc,f):((!((f == null)))?cljs.core.conj_BANG_.call(null,acc,f):acc
));
var G__21784 = cljs.core.subvec.call(null,v__$1,(1));
acc = G__21783;
v__$1 = G__21784;
continue;
}
...
//# sourceMappingURL=hiccup.js.map?rel=1538856219178
