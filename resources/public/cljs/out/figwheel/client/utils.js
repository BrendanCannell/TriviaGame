...
var or__3949__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj28692 = {"detail":data};
return obj28692;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__3938__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__3938__auto__)){
var and__3938__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__28699 = cljs.core._EQ_;
var expr__28700 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28699.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28700))){
return ((function (pred__28699,expr__28700){
return (function (p1__28693_SHARP_){
return console.warn(p1__28693_SHARP_);
});
;})(pred__28699,expr__28700))
} else {
if(cljs.core.truth_(pred__28699.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28700))){
return ((function (pred__28699,expr__28700){
return (function (p1__28694_SHARP_){
return console.debug(p1__28694_SHARP_);
});
;})(pred__28699,expr__28700))
} else {
if(cljs.core.truth_(pred__28699.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28700))){
return ((function (pred__28699,expr__28700){
return (function (p1__28695_SHARP_){
return console.error(p1__28695_SHARP_);
});
;})(pred__28699,expr__28700))
} else {
return ((function (pred__28699,expr__28700){
return (function (p1__28696_SHARP_){
return console.log(p1__28696_SHARP_);
});
;})(pred__28699,expr__28700))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28703){
...
var eval_fn = cljs.core.get.call(null,map__28704__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__28706_SHARP_){
return new_def.callback(p1__28706_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__28708,(0),null);
var v = cljs.core.nth.call(null,vec__28708,(1),null);
...
if(cljs.core.truth_((function (){var and__3938__auto__ = (((typeof localStorage !== 'undefined')) && (!((goog.object.get(localStorage,"getItem") == null))));
...
//# sourceMappingURL=utils.js.map?rel=1538856227278
